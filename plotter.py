...
if __name__ == '__main__':
    ...
    plot_npys('./Results/agents', ['SpritesState-v1', 'Sprites-v1', 'Sprites-v1', 'Sprites-v1'], ['oracle', 'cnn', 'image_scratch', 'reward_predictor'], 'Sprites-v1', 'step', 'reward', 2000)
    plot_npys('./Results/agents', ['SpritesState-v2', 'Sprites-v2', 'Sprites-v2', 'Sprites-v2'], ['oracle', 'cnn', 'image_scratch', 'reward_predictor'], 'Sprites-v2', 'step', 'reward', 2000)
